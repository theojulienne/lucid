/*
	Taken from http://www.cs.ucsb.edu/~tyang/class/pthreads/index_sgi.html
	Written by Dr. Tao Yang. Copyright and license unknown. The author has been contacted.
*/
...
void main(int argc, char *argv[])
{
	...
	for (i = 0; i < n; i++)
	{
		p[i].id = i;
		p[i].nproc = n;
		pthread_create(&threads[i], NULL, greeting, (void *)(p+i));
	}
